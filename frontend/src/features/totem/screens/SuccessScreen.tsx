  ...
  return (
    <div className="w-full max-w-xl animate-rise text-center">
      <div className="relative mx-auto grid h-32 w-32 place-items-center">
        ...
        <span className="grid h-28 w-28 animate-pop place-items-center rounded-full bg-ok text-white shadow-card">
          <IconCheck className="h-16 w-16" />
        </span>
      </div>
      <h1 className="mt-6 text-4xl font-bold tracking-tight">Chegada confirmada!</h1>
      <p className="mt-3 text-xl text-ink-muted">
        {resultado.paciente_nome}, aguarde na recepção. Você será chamado(a) em breve.
      </p>

      <div className="mx-auto mt-8 inline-flex flex-col gap-1 rounded-xl2 bg-white px-8 py-5 text-left shadow-card ring-1 ring-surface-line">
