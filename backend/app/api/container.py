...
class Container:
    ...
    def obter_guiches(self) -> ObterGuichesUseCase:
        return ObterGuichesUseCase(self.uow)

    def salvar_guiches(self) -> SalvarGuichesUseCase:
        return SalvarGuichesUseCase(self.uow)
